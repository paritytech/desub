...
fn convert_module(index: usize, module: runtime_metadata_latest::ModuleMetadata) -> Result<ModuleMetadata, Error> {
...
fn convert_event(event: runtime_metadata_latest::EventMetadata) -> Result<ModuleEventMetadata, Error> {
