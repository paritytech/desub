...
fn convert_module(index: usize, module: runtime_metadata09::ModuleMetadata) -> Result<ModuleMetadata, Error> {
...
fn convert_entry(prefix: String, entry: runtime_metadata09::StorageEntryMetadata) -> Result<StorageMetadata, Error> {
